    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                            ...
                            <table class="table1" align="center">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input style="margin-bottom:5px; margin-left:5px" type="text" name="ten"
               ...
               " onclick="location.href='./indexCus.php'">
                                            Nhập mới
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div id="gridContent">
                        ...
                        <table class="table table-sm table-bordered table-hover table-striped">
                            <thead>
                                <tr class="thead-dark">
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorID&amp;sortdir=ASC">Mã Khách Hàng</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorName&amp;sortdir=ASC">Tên Khách Hàng</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=PhoneNumber&amp;sortdir=ASC">Địa Chỉ</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">Giới Tính</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">Ngày Sinh</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">SĐT</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">Email</a>
                                    </th>
                                    <th scope="col">
