...
<head>
    ...
    <link rel="stylesheet" href="./BaiTap/PHPvaFORM/Baitap6/style.css">
...
<body>
    <div class="container">
        ...
        <form action="./BaiTap/PHPvaFORM/Baitap6/ketquapheptinh.php" method="post">
            <table>
                <tr>
                ...
                <tr>
                    <td style="text-align: center" colspan="2"><input name="submit" type="submit" value="Tinh"></td>
                </tr>
            </table>
