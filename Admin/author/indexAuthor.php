    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               " onclick="location.href='./indexAuthor.php'">
                                            Nhập mới
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <p>
                        <a href="new.php">Tạo Mới T&#225;c Giả</a>
                    </p>
                    <div id="gridContent">
                        ...
                        <table class="table table-sm table-bordered table-hover table-striped">
                            <thead>
                                <tr class="thead-dark">
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorID&amp;sortdir=ASC">M&#227; T&#225;c Giả</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorName&amp;sortdir=ASC">T&#234;n T&#225;c
                                            Giả</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=PhoneNumber&amp;sortdir=ASC">Số Điện Thoại</a>
                                    </th>
                                    <th scope="col">
