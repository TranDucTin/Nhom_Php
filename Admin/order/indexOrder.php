    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                            ...
                            <table class="table1" align="center">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Đến <input type="date" name="dateEnd" />
                                    </td>
                                </tr>
               ...
               " onclick="location.href='./indexOrder.php'">
                                            Nhập mới
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div id="gridContent">
                        ...
                        <table class="table table-sm table-bordered table-hover table-striped">
                            <thead>
                                <tr class="thead-dark">
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorID&amp;sortdir=ASC">Mã Đơn Hàng</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=AuthorName&amp;sortdir=ASC">Mã Khách Hàng</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=PhoneNumber&amp;sortdir=ASC">Tên Khách Hàng</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=PhoneNumber&amp;sortdir=ASC">SĐT</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">Địa Chỉ</a>
                                    </th>
                                    <th scope="col">
                                        <a href="/Admin/Authors?sort=Url&amp;sortdir=ASC">Ngày đặt</a>
                                    </th>
                                    <th scope="col">
